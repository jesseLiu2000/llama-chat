...
class main:
    ...
    #global generator
        generator = load(
        "/scratch/cnicholas/helm_llama/weights/13B", "/scratch/llama/weights/tokenizer.model",
...
MAIN = main("/scratch/cnicholas/helm_llama/weights/7B", "/scratch/llama/weights/tokenizer.model")
